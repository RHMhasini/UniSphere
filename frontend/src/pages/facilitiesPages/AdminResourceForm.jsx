...
export default function AdminResourceForm() {
  ...
  const addWindow = () => {
    setForm({
      ...form,
      availabilityWindows: [...form.availabilityWindows, { ...defaultWindow }],
    });
  };
      ...
      <div className="admin-header">
        <div>
          ...
          <p className="admin-header__sub">
            View, add, edit, and remove lecture halls, labs, meeting rooms, and equipment.
          </p>
        </div>
      </div>
        ...
        <section className="admin-table-card">
          ...
          {listLoading ? (
            ...
            <div className="table-empty">
              No resources match your search. Try another name, capacity or location.
            </div>
          ) : (
              ...
              <div>
                ...
                <p>
                  {selectedResource
                    ...
                    : 'Create a new resource and assign it to the correct category.'}
                </p>
              </div>
            ...
            <form className="admin-form" onSubmit={handleSubmit}>
              ...
              <div className="form-group">
                    ...
                    <div key={i} className="window-row">
                      ...
                      <input
                        ...
                        className={`form-input time-input ${
                          errors[`availabilityWindows.${i}.start`] ? 'input-error' : ''
                        }`}
                        value={w.start}
                      ...
                      <input
                        type="time"
                        className={`form-input time-input ${
                          errors[`availabilityWindows.${i}.end`] ? 'input-error' : ''
                        }`}
                        value={w.end}
                ...
                {errors.availabilityWindows && (
                  <p className="field-error">{errors.availabilityWindows}</p>
                )}
                {Object.keys(errors)
                  ...
                  {STATUS_OPTIONS.map((option) => (
                    <label
                      ...
                      className={`status-option ${
                        form.status === option
                          ? `status-option--${option === 'ACTIVE' ? 'active' : 'oos'}`
                          : ''
                      }`}
                    >
                      <input
              ...
              <div className="form-actions">
                ...
                <button
                  type="button"
                  className="btn-form-cancel-secondary"
                  onClick={closeForm}
                >
                  Cancel
                </button>
