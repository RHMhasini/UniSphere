    ...
    <div className="cat-page">
      ...
      <div className="cat-header" style={{ '--cat-accent': accentColor }}>
        ...
        <button
          ...
          type="button"
          onClick={() => navigate('/dashboard/resources/manage')}
        >
          + Add Resource
        </button>
      </div>
            ...
            <tbody>
              {filtered.map((r, idx) => (
                <tr key={r.id} className="cat-table__row">
                  ...
                  <td>
                    <span className="cat-windows-badge">
                      {r.availabilityWindowCount ?? 0} window
                      {r.availabilityWindowCount !== 1 ? 's' : ''}
                    </span>
                  ...
                  <td>
                    {editingId === r.id ? (
                      <div className="cat-inline-edit">
                        ...
                        <button className="cat-save-btn" onClick={() => handleStatusUpdate(r)}>
                          Save
                        </button>
